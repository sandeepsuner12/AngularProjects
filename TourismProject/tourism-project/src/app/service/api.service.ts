...
export class ApiService {
  ...
  verifyAdminCredinatials(customcredentials : CustomCredentials): Observable<any>{
    ...
    // });
      // return this.httpClient.post("http://localhost:8080/testdemo/adminVerify",customcredentials,{ headers });
      return this.httpClient.post("http://localhost:8080/adminloginverify",customcredentials);
      
  }

  verifyUserCredinatials(customcredentials : CustomCredentials): Observable<any>{
    return this.httpClient.post("http://localhost:8080/userloginVerify", customcredentials)
 }
...
//  _______________for package list
 getAllPacakges():Observable<any>{
  ...
  //     'Authorization': 'Bearer ' + sessionStorage.getItem("access_token")
  // })
  return this.httpClient.get("http://localhost:8080/packages");
 }
 ...
 deletePackageWithId(id : number): Observable<any>{
  ...
  return this.httpClient.delete("http://localhost:8080/admin/package",{params:param, headers: this.headers});
 }
...
getAllUsers():Observable<any>{
  ...
  return this.httpClient.get("http://localhost:8080/admin/users", { headers: this.headers })
}
...
getPacakageWithId(id:number): Observable<any>{
  ...
  return this.httpClient.get("http://localhost:8080/admin/package",{params: param, headers: this.headers });
}
...
updatePackageWithId(pacakge :Package):Observable<any>{
  ...
  return this.httpClient.put("http://localhost:8080/admin/package",pacakge,{params:param, headers: this.headers });
}

//_________________________for add pacakge
addPackage(pacakage:Package):Observable<any>{
  return this.httpClient.post("http://localhost:8080/admin/package",pacakage,{ headers: this.headers });
 }

 //_______________________________for bookings pacakges

 getAllBookings():Observable<any>{
  return this.httpClient.get("http://localhost:8080/booking",{ headers : this.headers});
 }
 ...
 getUserByEmail(email:string):Observable<any>{
  ...
  return this.httpClient.get("http://localhost:8080/userbyemail",{params:param,headers :this.headers})
 }

 getTravelHistoryByEmail(email:string):Observable<any>{
  let param= new HttpParams().set('username',email);
  return this.httpClient.get("http://localhost:8080/user/booking",{params:param, headers:this.headers})
 }

 updatePasswordByeEamil(email:string,password:any):Observable<any>{
  let param= new HttpParams().set('email',email);
  console.log(email,password)
  return this.httpClient.post("http://localhost:8080/confirmpassword",password,{params:param})
 }

 //----------------------------for forgot password 

 verifyUserEmailandPhNo(user:any):Observable<any>{
  return this.httpClient.post("http://localhost:8080/forgotpassword",user,{headers : this.headers});
 }

 //--------------------------for booking tickites
 bookTicket(ticket:any):Observable<any>{
  return this.httpClient.post("http://localhost:8080/booking",ticket,{headers : this.headers});
